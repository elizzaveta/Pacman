...
class Game:
    ...
    def __init__(self, num_of_ghosts_type1, num_of_ghosts, alg):
        ...
        self.grid = Grid(20, 11, read_2d_array("layout/walls.txt"), read_2d_array("layout/food.txt"), 97)
    ...
    def run(self):
        ...
        self.statistics.add_statistics(self.win, time.time() - start_time, abs(self.score), self.algorithm)
